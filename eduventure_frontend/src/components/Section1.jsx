    ...
    return (
        <div className='flex flex-col lg:flex-row px-3 sm:px-12 py-12 md:py-32 m-4 gap-10'>
            ...
            <div className="w-full lg:w-3/5 flex flex-col gap-7 items-center lg:items-start justify-center">
                <h1 className='text-4xl sm:text-5xl md:text-6xl lg:text-5xl xl:text-7xl font-semibold'>Empower Your</h1>
                <h1 className='text-4xl sm:text-5xl md:text-6xl lg:text-5xl xl:text-7xl font-semibold text-tertiary text-center'>Campus Experience</h1>
